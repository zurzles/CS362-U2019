...
int main() {
	...
	choice1 = 1;
	choice2=-3;
	MYASSERT(drewAmbassadorCard(choice1,choice2,handpos,thisPlayer,&testG)!=0);
	...
	drewAmbassadorCard(choice1,choice2,handpos,thisPlayer,&testG);
	...
	MYASSERT(drewAmbassadorCard(choice1,choice2,handpos,thisPlayer,&testG));
